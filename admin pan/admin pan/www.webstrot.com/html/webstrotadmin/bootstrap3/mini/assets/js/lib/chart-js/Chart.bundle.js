	...
	var TimeScale = Chart.Scale.extend({
		...
		parseTime: function(label) {
			...
			if (typeof me.options.time.format !== 'string' && me.options.time.format.call) {
				console.warn('options.time.format%20is%20deprecated%20and%20replaced%20by%20options.time.parser.%20See%20http_/nnnick.github.io/Chart.js/docs-v2/index.html#scales-time-scale');
